		...
		if ( ! class_exists( 'JEM_Table_Rate_Shipping_Method' ) ) {
			class JEM_Table_Rate_Shipping_Method extends WC_Shipping_Method {
				...
				public function __construct() {
					...
					$this->options			  = [];									//the actual tabel rate options saved 
 					$this->condition_array	= [];									//holds an array of CONDITIONS for the select
					$this->country_array	= [];									//holds an array of COUNTRIES for the select
